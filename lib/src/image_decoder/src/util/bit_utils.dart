...
final Int8List __int8 = Int8List(1);
final Uint8List __int8ToUint8 = Uint8List.view(__int8.buffer);

final Uint16List __uint16 = Uint16List(1);
final Int16List __uint16ToInt16 = Int16List.view(__uint16.buffer);

final Int16List __int16 = Int16List(1);
final Uint16List __int16ToUint16 = Uint16List.view(__int16.buffer);
